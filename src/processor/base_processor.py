...
class BaseProcessor(ABC):
    ...
    # @abstractmethod
    # async def generateSummary(self, article:Article, actualText:str):
    #     """Generate Summary from abstract and title and actual text and update Article in-place"""
    #     pass

    # @abstractmethod
    # async def generateKeywords(self, article:Article, actualText:str):
    #     """Generate Keywords from abstract,title and actual text and update Article in-place"""
    #     pass
